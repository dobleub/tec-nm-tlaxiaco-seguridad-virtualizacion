...
___El router nos ayuda a expandir la señal de wifi y la diferencia del switch es que este no expande señal de forma inalambrica sino a travez de cable___
...
___Porque es un protocolo el cual trabaja con todos los tipos de red___

Pregunta Abierta:<br>
Describe las diferencias clave entre TCP y UDP en términos de fiabilidad y uso.<br>
___TCP: Garantiza la entrega de datos en el orden correcto y sin errores. Si un paquete se pierde o se daña, TCP lo retransmite.
 UDP: No garantiza la entrega de datos. Si un paquete se pierde o se daña, UDP no lo retransmite___
...
___Es importante ya que al darle seguimiento tomando en cuenta las normas y estandares se logra diseñar y con un buen rendumiento___
...
___Pues dependiendo de que tipo de red este utilizando se le daria seguiento de acuerdo a las normas y estandares___
...
___De acuerdo a sus necesidades___
...
___checar sila infraestructura cuenta con la estructura adecuada para implementar una red___
...
___No se aprovecharia la eficacia de la red implementada___
...
___la metodologia PPDIOO la cual se basa en Preparación, Planificación, Diseño, Implementación, Operación, Optimización___
...
___Pues con la metodologia PPDIOO seguiria todas y cada una de las fases para poder terminar un buen proyecto___
...
___Es importante porque como ya lo dijo esta protege la informacion___
...
___primero la reiniciaria y si el problema persiste entraria en las propiedades de la red y solucionar problema, o checar si nada mas es de cierta red de internet o de todas___
...
___Hoy en dia es muy importante ya que la mayoria de lugares tienen el servicio de internet y es comun que ciertas redes muestren problemas a la hora de intentar conectarse___
